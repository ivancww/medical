...
function calculate(input){
 const wise=calculatePlan('wise',LEGACY_RULES.wise,input.items||{},input.context||{}),flexi=calculatePlan('flexi',LEGACY_RULES.flexi,input.items||{},input.context||{});
...
root.AVAMedicalClaimEngine={LEGACY_RULES,SURGERY,calculatePlan,calculate};
